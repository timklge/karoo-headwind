...
- Headwind time (numerical): Shows the accumulated time spent riding into a headwind of at least 1 m/s during the current ride. The value resets when a new ride starts.
